...
const AddSupporter = (props : any) => {
    ...
    return ( <div>
        <button disabled={supported} onClick={()=> setSupport(true)} className=" hover:bg-accent disabled:bg-link disabled:text-gray-300 text-[1.0rem] font-semibold hover:text-white bg-secondary py-3 px-3 rounded duration-300 text-white flex items-center justify-center gap-2 ">Support</button>

        ...
        if (props.type === "file") {
            ...
            <div className="text-left">
                ...
                <div className="transtion duration-200 p-2 border-2 bg-white border-gray-300 rounded w-full focus-within:border-accent hover:border-accent hover:shadow-md focus-within:shadow-md ">
                    <input onChange={(e) => props.setValue(e.target.files) } type="file" accept="image/png,image/gif,image/jpeg, image/jpg" placeholder="Upload you profile image " className="appearance-none border-none focus:outline-none bg-transparent w-full" />
                </div>
            </div>
            );
